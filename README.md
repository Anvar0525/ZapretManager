...
- **Подбор рабочей стратегии** (YouTube): при первой установке сам, потом — кнопкой
...
- **Автозапуск с Windows** и **обновления zapret** — в разделе «Настройки»
- **При старте включать обход** — тоже в «Настройках»
